...
NewGateway creates a new gateway manager. If opts is nil, sensible defaults are used for all dependencies.
...
```go
func (*Gateway) Dispatcher() *events.Dispatcher
```
...
```go
func (*Gateway) On(eventType events.Type, handler events.RawHandler) error
```
...
```go
func (*Gateway) OnChannelCreate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnChannelDelete(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnChannelUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildBanAdd(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildBanRemove(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildCreate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildDelete(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildMemberAdd(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildMemberRemove(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildMemberUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildMembersChunk(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildRoleCreate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildRoleDelete(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildRoleUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnGuildUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnInteractionCreate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnInviteCreate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnInviteDelete(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnMessageCreate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnMessageDelete(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnMessageDeleteBulk(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnMessageReactionAdd(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnMessageReactionRemove(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnMessageUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnPresenceUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnReady(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnTypingStart(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnVoiceServerUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) OnVoiceStateUpdate(handler *ast.IndexExpr) error
```
...
```go
func (*Gateway) RequestGuildMembers(ctx context.Context, data *RequestGuildMembersData) error
```
...
Start connects to the Discord gateway and blocks until SIGINT or SIGTERM. Automatically fetches gateway URL and shard count from Discord API.

```go
func (*Gateway) Start(ctx context.Context) error
```
...
```go
func (*Gateway) UpdateVoiceState(ctx context.Context, data *VoiceStateUpdateData) error
```
...
```go
func (*Gateway) Stop(ctx context.Context) error
```
...
```go
func (*Gateway) UpdatePresence(ctx context.Context, presence *PresenceUpdate) error
```
...
### Listen
Listen is a convenience helper that registers a typed handler for an event. Example: gateway.Listen(gw, events.MessageCreate, func(ctx context.Context, e *events.MessageCreateEvent) { fmt.Printf("Message: %s\n", e.Content) })

```go
func Listen(g *Gateway, eventType events.Type, handler *ast.IndexExpr) error
```
...
```go
func OnEvent(g *Gateway, eventType events.Type, handler *ast.IndexExpr) error
```
